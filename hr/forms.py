...
class EmployeeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'job_owner': forms.Select(attrs={'class': 'form-control inputs'}),
            'owner_side': forms.Select(attrs={'class': 'form-control inputs', 'placeholder': "Owner Side"}),
            'actual_work_area': forms.Select(attrs={'class': 'form-control inputs'}),
            'actual_work_side': forms.Select(attrs={'class': 'form-control inputs'}),
            ...
            'manager_name': forms.Select(attrs={'class': 'form-control inputs'}),
